...
const projectsData = [
  ...
  },
  {
    id: 5,
    title: "E-commerce",
    description: "API REST feita para uma simulação de e-commerce com Node/TS/Express. Autenticação com (bcrypt, JWT), Prisma ORM, princípios SOLID, confirmação de e-mail integrada no momento do Login, AWS S3 para upload de arquivos de relatórios de vendas e Docker para a aplicação e BD(PostgreSQL).",
    image: "/images/projects/ecommerce.jpg",
    tag: ["Todos", "BackEnd"],
    gitUrl: "https://github.com/gaabrieltorres7/challenge-BE",
    previewUrl: "https://github.com/gaabrieltorres7/challenge-BE",
  },
  // {
  //   id: 6,
  //   title: "",
